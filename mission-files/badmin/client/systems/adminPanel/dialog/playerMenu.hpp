...
class PlayersMenu
{
	...
	class controls {
		...
		class PlayerListBox: w_RscList
		{
			...
			onLBSelChanged="[2,_this select 1] execVM ""badmin\client\systems\adminPanel\importvalues.sqf"";";
		...
		class SpectateButton: w_RscButton
		{
			...
			text = "Spectate";
			onButtonClick = "[0] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
			x = 0.2 * safezoneW + safezoneX;
		...
		class SlayButton: w_RscButton
		{
			idc = -1;
			text = "Kill";
			onButtonClick = "[2] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
			x = 0.2 * safezoneW + safezoneX;
		...
		class WarnButton: w_RscButton
		{
			idc = -1;
			text = "Warn";
			onButtonClick = "[1] execVM 'badmin\client\systems\adminPanel\playerSelect.sqf'";
